...
function task3(cf) {
    setTimeout(() => {
        console.log('Task 3 in progress');
        cf(3);
    }, 1000);
    return cf;
}

// cf => callback function - { (data) => console.log(`Task ${data} completed`) }
// callback hell
task1(task2(task3((data) => console.log(`Task ${data} completed`))));
...
fetchData((data) => console.log(`Callback param: ${data}`));
